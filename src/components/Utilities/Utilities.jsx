...
import amenity from '../../assets/amenities.jpeg';
    ...
    <Box sx={{  overflow: 'hidden',width:"28vw"}}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center' }}>
        <Button
          ...
          sx={{width:"100%",height:"50px",backgroundColor:"rgb(80,120,225)",padding:"20px",textTransform:"none",marginTop:"20px",marginBottom:"20px"}}
        >
          Update & Save
        </Button>
      </Box>
