...
const Amenities = ({close}) => {
  ...
  return (
    <Box sx={{ overflow: 'hidden', width: '28vw' }}>
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', gap: '10px',width:"28vw" ,backgroundColor:"rgb(254,244,244)",padding:"10px",borderRadius:"5px"}}>
        <Box component="img" src={amenity} alt="Lead Profile" sx={{ height: 40, width: 40 }} >

        </Box>

        <Typography color='rgb(179,119,109)'><span style={{ fontWeight: 'bold',color:"rgb(179,119,109)" }}>03</span> Total Amenities</Typography>
<Box  ><Typography paddingLeft={"150px"} color='rgb(179,119,109)' fontWeight={"bold"}>$200.00</Typography></Box>
        </Box>
